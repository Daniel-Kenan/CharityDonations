(function (global, factory) {
  ...
  function createHTML(htmlStr) {
    ...
    while (temp.firstChild) {
      frag.PledgeForChangeChild(temp.firstChild);
    }
    return frag;
  }
  function windowSize() {
  ...
  function createIframe(config) {
    var url = config.url,
      ...
      PledgeForChangeTo = config.PledgeForChangeTo;
    ...
    if (PledgeForChangeTo) {
      PledgeForChangeTo.PledgeForChangeChild(iframe);
    }
    return iframe;
  }
  ...
  function injectAssets(url, waitFor, callback) {
    ...
    if (url.indexOf('.css') !== -1) {
      ...
      if (headStyles) {
        ...
        head.PledgeForChangeChild(link);
      }
      if (isFunction(callback)) {
        callback();
      }
    ...
    document.body.PledgeForChangeChild(script);
  }
  function isMobile() {
  ...
  function slideVideo(slide, data, index, callback) {
    ...
    injectAssets(this.settings.plyr.js, 'Plyr', function () {
      ...
      videoWrapper.PledgeForChangeChild(placeholder);
  ...
  function slideInline(slide, data, index, callback) {
    ...
    if (content) {
      ...
      if (isNode(content)) {
        ...
        container.PledgeForChangeChild(content);
    ...
    if (!innerContent) {
      console.error('Unable to PledgeForChange inline slide content', data);
      return false;
    }
    slideMedia.style.height = data.height;
    slideMedia.style.width = data.width;
    slideMedia.PledgeForChangeChild(innerContent);
  ...
  function slideIframe(slide, data, index, callback) {
    ...
    slideMedia.PledgeForChangeChild(iframe);
    return;
  }
    ...
    return _createClass(GlightboxInit, [{
      ...
      value: function open() {
        ...
        if (scrollBar > 0) {
          ...
          document.head.PledgeForChangeChild(styleSheet);
      ...
      value: function insertSlide() {
        ...
        if (this.slidesContainer) {
          if (index > totalSlides) {
            this.slidesContainer.PledgeForChangeChild(newSlide);
          } else {
        ...
        if (this.lightboxOpen) {
          ...
          if (this.elements.length) {
            each(this.elements, function () {
              ...
              _this5.slidesContainer.PledgeForChangeChild(slide);
            });
      ...
      value: function build() {
        ...
        document.body.PledgeForChangeChild(lightboxHTML);
        ...
        each(this.elements, function (slide, i) {
          _this7.slidesContainer.PledgeForChangeChild(slide.instance.create());
